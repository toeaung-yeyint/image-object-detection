<template>
	<div class="max-w-screen-lg my-28 mx-auto px-8">
		...
		<div v-show="result" class="flex flex-col lg:flex-row items-center">
			<div class="relative w-full lg:w-2/3 mb-8 lg:mb-0" ref="imageWithObjects">
				<img class="w-full" :src="src" alt="" ref="resultImage" />
				<span
					class="hidden cursor-default lg:text-lg lg:font-medium lg:inline-block lg:border-2 lg:border-[#00ff00] lg:text-white lg:absolute lg:bg-black lg:bg-opacity-20 lg:hover:bg-opacity-30"
...
const imageWithObjects = ref(null);
